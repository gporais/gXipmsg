gXipmsg : main.o udp.o pack.o appIcon.o sendForm.o recvDialog.o
	cc -g -o gXipmsg main.o udp.o pack.o appIcon.o sendForm.o recvDialog.o -lXm -lXt -lSM -lICE -lX11
